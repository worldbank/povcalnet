...
1. In the [GitHub repository](https://github.com/worldbank/povcalnet) of the `povcalnet` Stata command, click on the green icon "Clone or Download" at the top. 
